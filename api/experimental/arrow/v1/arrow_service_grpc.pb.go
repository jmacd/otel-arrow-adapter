...
type ArrowStreamServiceClient interface {
	// ArrowStream supports delivery of mixed signals on a single stream.
...
type ArrowTracesServiceClient interface {
	// ArrowTraces supports only SPANS_DATA.
...
type ArrowMetricsServiceClient interface {
	// ArrowMetrics supports only METRICS_DATA.
...
type ArrowLogsServiceClient interface {
	// ArrowLogs supports only LOGS_DATA.
